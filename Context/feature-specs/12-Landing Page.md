...
> Beautiful, animated landing page that converts visitors into users.
> Complete with Arabic/English support, smooth animations, and user-type examples.
...
├── How It Works (3 user types: Owner, Staff, Customer)
├── Features Showcase (animated cards)
├── Pricing (plans)
...
┌─────────────────────────────────────────────────┐
│                                                 │
│         حجز مواعيد حلاقة بسهولة           │
│      Booking Barbershop Appointments Easily    │
│                                                 │
│      نظام حجوزات ذكي لمشاريعك الصغيرة       │
│    Smart booking system for your barbershop    │
│                                                 │
...
/* ===== NEUMORPHISM HOVER EFFECTS ===== */

.neu-card-hover {
  box-shadow: 8px 8px 16px rgba(200, 205, 211, 1),
...
## PART 3: Tailwind CSS Configuration
...
```json
{
  ...
  "hero": {
    "title": "احجز حلاقتك بسهولة 💇",
    "description": "نظام حجوزات ذكي يجعل إدارة مشروعك أسهل من أي وقت مضى",
    "book_now": "احجز الآن",
    "get_started": "ابدأ مجاناً"
  },
  "landing": {
    "how_it_works": "كيف يعمل؟",
    "how_it_works_description": "لكل شخص حل مختلف - اختر دورك",
    "free": "مجاني"
  }
}
```
...
```json
{
  ...
  "hero": {
    "title": "Book Your Haircut Easily 💇",
    "description": "Smart booking system that makes managing your business easier than ever",
    "book_now": "Book Now",
    "get_started": "Start Free"
  },
  "landing": {
    "how_it_works": "How it Works?",
    "how_it_works_description": "Different solutions for everyone - choose your role",
    "free": "free"
  }
}
```
...
### Component: `src/components/landing/FeatureCard.tsx`
...
### Component: `src/components/landing/PricingCard.tsx`
...
### Pages
- [ ] `src/app/[locale]/(public)/page.tsx` — Main landing page
...
### Content
- [ ] Owner example with steps
- [ ] Staff example with timeline
- [ ] Customer example with flow
...
1. **Hero**: Catch attention → CTA buttons
2. **How it Works**: Show benefits for each role
3. **Features**: Build confidence
4. **Pricing**: Offer flexible options
5. **FAQ**: Remove doubts
6. **CTA**: Final push to conversion
